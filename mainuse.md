...
# 01.train
```sh
cd Legged_gym_handstand-for-DeepRobotics-JueYing-Lite3/legged_gym/script
...
# Resume-train
python train.py --task=lite3 --resume --load_run May04_16-55-46_ --checkpoint 500 --headless --max_iterations=3000
